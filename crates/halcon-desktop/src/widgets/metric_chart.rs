...
impl MetricChart {
    ...
    pub fn render(&self, ui: &mut Ui, size: Vec2) {
        ...
        // Background.
        painter.rect_filled(rect, 4.0, HalconTheme::BG_SECONDARY);
        painter.rect_stroke(rect, 4.0, egui::Stroke::new(1.0, HalconTheme::BORDER));
        ...
        for window in points.windows(2) {
            painter.line_segment(
                [window[0], window[1]],
                egui::Stroke::new(1.5, HalconTheme::ACCENT),
            );
        }
