...
/// HTTP endpoints, and remote Halcon instances.
#[async_trait]
...
impl fmt::Display for AgentKind {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            AgentKind::HalconRemote => write!(f, "halcon_remote"),
...
impl FromStr for AgentKind {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        match s {
            ...
            "halcon_remote" => Ok(AgentKind::HalconRemote),
...
mod tests {
    ...
    fn agent_kind_display() {
        ...
        assert_eq!(AgentKind::HalconRemote.to_string(), "halcon_remote");
