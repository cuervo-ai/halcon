...
impl Database {
    ...
    pub fn save_checkpoint(&self, checkpoint: &SessionCheckpoint) -> Result<()> {
        ...
        .map_err(|e| HalconError::DatabaseError(format!("save checkpoint: {e}")))?;
    ...
    pub fn load_checkpoint(
        ...
        .optional()
        .map_err(|e| HalconError::DatabaseError(format!("load checkpoint: {e}")))?;
    ...
    pub fn load_latest_checkpoint(&self, session_id: Uuid) -> Result<Option<SessionCheckpoint>> {
        ...
        .optional()
        .map_err(|e| HalconError::DatabaseError(format!("load latest checkpoint: {e}")))?;
