...
impl Database {
    ...
    pub fn save_episode(&self, episode: &MemoryEpisode) -> Result<()> {
        ...
        .map_err(|e| HalconError::DatabaseError(format!("save episode: {e}")))?;
    ...
    pub fn load_episode(&self, episode_id: &str) -> Result<Option<MemoryEpisode>> {
        ...
        let episode = stmt
            ...
            .optional()
            .map_err(|e| HalconError::DatabaseError(format!("load episode: {e}")))?;
    ...
    pub fn link_entry_to_episode(
        ...
        .map_err(|e| HalconError::DatabaseError(format!("link entry to episode: {e}")))?;
    ...
    pub fn load_episode_entries(&self, episode_id: &str) -> Result<Vec<MemoryEntry>> {
        ...
        let entries = stmt
            ...
            .map_err(|e| HalconError::DatabaseError(format!("load episode entries: {e}")))?
    ...
    pub fn count_episodes(&self) -> Result<u64> {
        ...
        let count: u64 = conn
            ...
            .map_err(|e| HalconError::DatabaseError(format!("count episodes: {e}")))?;
    ...
    fn row_to_episode(row: &rusqlite::Row) -> Result<MemoryEpisode> {
        ...
        let ended_at = ended_at_str
            ...
            .transpose()
            .map_err(|e| HalconError::DatabaseError(format!("parse ended_at: {e}")))?
