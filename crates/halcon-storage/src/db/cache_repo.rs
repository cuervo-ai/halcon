...
impl Database {
    ...
    pub fn insert_cache_entry(&self, entry: &crate::cache::CacheEntry) -> Result<()> {
        ...
        .map_err(|e| HalconError::DatabaseError(format!("insert cache: {e}")))?;
    ...
    pub fn lookup_cache(&self, cache_key: &str) -> Result<Option<crate::cache::CacheEntry>> {
        ...
        let mut stmt = conn
            ...
            .map_err(|e| HalconError::DatabaseError(format!("prepare cache: {e}")))?;
        ...
        let entry = stmt
            ...
            .optional()
            .map_err(|e| HalconError::DatabaseError(format!("lookup cache: {e}")))?;
    ...
    pub fn clear_cache(&self) -> Result<u32> {
        ...
        let removed = conn
            ...
            .map_err(|e| HalconError::DatabaseError(format!("clear cache: {e}")))?;
    ...
    pub fn prune_cache(&self, max_entries: u32) -> Result<u32> {
        ...
        let expired = conn
            ...
            .map_err(|e| HalconError::DatabaseError(format!("prune expired cache: {e}")))?;
        ...
        if max_entries > 0 {
            let total: u32 = conn
                ...
                .map_err(|e| HalconError::DatabaseError(format!("count cache: {e}")))?;
            ...
            if total > max_entries {
                ...
                let pruned = conn
                    ...
                    .map_err(|e| HalconError::DatabaseError(format!("prune excess cache: {e}")))?;
    ...
    pub fn cache_stats(&self) -> Result<crate::cache::CacheStats> {
        ...
        let (total_entries, total_hits, oldest_str, newest_str): (u32, u64, Option<String>, Option<String>) = conn
            ...
            .map_err(|e| HalconError::DatabaseError(format!("cache stats: {e}")))?;
    ...
    pub fn top_cache_entries(&self, limit: usize) -> Result<Vec<crate::cache::CacheEntry>> {
        ...
        let entries = stmt
            ...
            .map_err(|e| HalconError::DatabaseError(format!("top cache: {e}")))?
