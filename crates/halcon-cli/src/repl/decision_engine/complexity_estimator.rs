...
const DEPTH_TERMS: &[&str] = &[
    ...
    "microservice", "microservicio", "distributed system", "sistema distribuido",
    "scalability", "escalabilidad", "coupling", "acoplamiento",
    "cohesion", "cohesión", "abstraction", "abstracción",
    "dependency injection", "inyección de dependencias",
    "hexagonal", "cqrs", "event sourcing", "saga pattern",
    "domain-driven", "ddd", "clean architecture", "solid",
    "performance bottleneck", "cuello de botella", "latency", "latencia",
    "throughput", "concurrency", "concurrencia", "parallelism",
];

/// Analysis and investigation scope indicators.
const ANALYSIS_TERMS: &[&str] = &[
    "analyze", "analizar", "review", "revisar", "investigate", "investigar",
    "audit", "auditar", "inspect", "inspeccionar", "evaluate", "evaluar",
    "assess", "diagnose", "diagnosticar", "identify", "identificar",
    "comprehensive", "exhaustive", "exhaustivo", "deep", "profundo",
    "entire", "entero", "complete", "completo", "all", "todos",
    "across the", "en todo", "throughout", "a través de",
    "repository", "repositorio", "codebase", "entire project", "proyecto completo",
    "every module", "all modules", "todos los módulos",
    "end-to-end", "end to end", "de extremo a extremo",
    "from scratch", "desde cero", "full", "completa",
];

/// Code-related technical terminology.
const CODE_TERMS: &[&str] = &[
    "function", "función", "class", "clase", "module", "módulo",
    "interface", "trait", "enum", "struct", "method", "método",
    "algorithm", "algoritmo", "data structure", "estructura de datos",
    "async", "concurrent", "parallel", "recursion", "recursión",
    "memory", "heap", "stack", "lifecycle", "ciclo de vida",
    "api", "endpoint", "handler", "middleware", "pipeline",
    "test", "unit test", "integration test", "e2e", "coverage",
    "refactor", "refactorizar", "optimize", "optimizar",
    "bug", "error", "exception", "panic", "crash",
];
...
const SECURITY_TERMS: &[&str] = &[
    ...
    "exploit", "attack", "threat", "amenaza", "risk", "riesgo",
    "injection", "xss", "csrf", "owasp", "cve",
    "authentication", "autenticación", "authorization", "autorización",
    "privilege escalation", "escalada de privilegios",
    "penetration", "penetración", "pentest", "hardening",
    "encryption", "cifrado", "secret", "credential",
];
...
mod tests {
    ...
    fn multi_step_code_task_is_medium() {
        ...
        assert!(e.level >= ComplexityLevel::Medium, "level={:?} score={}", e.level, e.score);
    }
