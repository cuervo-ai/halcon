...
use halcon_core::types::HealthConfig;
...
pub fn compute_health_score(metrics: &halcon_storage::ProviderWindowedMetrics) -> u32 {
...
mod tests {
    ...
    fn compute_score_shared_formula() {
        use halcon_storage::ProviderWindowedMetrics;
