...
/// Backward-compatible type alias for callers that used `domain::decision_trace::DecisionTraceCollector`.
#[deprecated(note = "use agent_decision_trace::DecisionTraceCollector")]
pub type DecisionTrace = DecisionTraceCollector;
