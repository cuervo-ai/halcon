...
impl IntentGraph {
    ...
    pub fn coverage(&self, registered_tool_names: &[&str]) -> f32 {
        ...
        let covered = registered_tool_names
            .iter()
    ...
    fn collect_tools(&self, intents: &[IntentLabel], max: usize) -> Vec<String> {
        ...
        if max > 0 {
            tools.into_iter().take(max).collect()
        } else {
            tools
        }
    }
...
fn default_tool_nodes() -> Vec<ToolNode> {
    vec![
        ...
        ToolNode {
            ...
            intents: vec!["file_operation".into(), "code_review".into()],
            priority: 0.9,
        },
        ToolNode {
            tool_name: "file_write".into(),
            description: "Write/create a file".into(),
            intents: vec!["file_operation".into(), "artifact_creation".into()],
            priority: 0.9,
        },
        ToolNode {
            tool_name: "file_edit".into(),
            description: "Edit file in-place".into(),
            intents: vec!["file_operation".into(), "code_edit".into()],
            priority: 0.85,
        },
        ToolNode {
            tool_name: "file_delete".into(),
            description: "Delete a file".into(),
            intents: vec!["file_operation".into()],
            priority: 0.6,
        },
        ToolNode {
            tool_name: "file_inspect".into(),
            description: "Inspect file metadata".into(),
            intents: vec!["file_operation".into(), "discovery".into()],
            priority: 0.7,
        },
        ToolNode {
            tool_name: "file_diff".into(),
            description: "Diff two files".into(),
            intents: vec!["file_operation".into(), "code_review".into()],
            priority: 0.7,
        },
        ToolNode {
            tool_name: "directory_tree".into(),
            description: "List directory tree".into(),
            intents: vec!["file_operation".into(), "discovery".into()],
            priority: 0.75,
        },
        ...
        ToolNode {
            tool_name: "glob".into(),
            description: "Match files by pattern".into(),
            intents: vec!["file_operation".into(), "discovery".into()],
            priority: 0.8,
        },
        ToolNode {
            tool_name: "archive".into(),
            description: "Compress/extract archives".into(),
            intents: vec!["file_operation".into()],
            priority: 0.55,
        },
        ToolNode {
            tool_name: "checksum".into(),
            description: "Compute file checksums".into(),
            intents: vec!["file_operation".into(), "security".into()],
            priority: 0.5,
        },
        ToolNode {
            tool_name: "patch_apply".into(),
            description: "Apply a patch file".into(),
            intents: vec!["file_operation".into(), "code_edit".into()],
            priority: 0.7,
        },
        ToolNode {
            tool_name: "diff_apply".into(),
            description: "Apply unified diff".into(),
            intents: vec!["file_operation".into(), "code_edit".into()],
            priority: 0.7,
        },
        // ── Search & retrieval ────────────────────────────────────────────
        ToolNode {
            ...
            intents: vec!["search".into(), "code_review".into()],
            priority: 0.9,
        },
        ToolNode {
            tool_name: "semantic_grep".into(),
            description: "Semantic code search".into(),
            intents: vec!["search".into(), "code_review".into()],
            priority: 0.8,
        },
        ToolNode {
            tool_name: "symbol_search".into(),
        ...
        ToolNode {
            ...
            intents: vec!["web_access".into(), "search".into()],
            priority: 0.85,
        },
        ToolNode {
            tool_name: "web_fetch".into(),
            description: "Fetch URL content".into(),
            intents: vec!["web_access".into()],
            priority: 0.8,
        },
        ToolNode {
            tool_name: "fuzzy_find".into(),
            description: "Fuzzy file search".into(),
            intents: vec!["search".into(), "discovery".into()],
            priority: 0.75,
        },
        ToolNode {
            tool_name: "native_search".into(),
            description: "Local indexed search".into(),
            intents: vec!["search".into(), "discovery".into()],
            priority: 0.75,
        },
        ToolNode {
            tool_name: "native_index_query".into(),
            description: "Query native index".into(),
            intents: vec!["search".into(), "discovery".into()],
            priority: 0.7,
        },
        ToolNode {
            tool_name: "native_crawl".into(),
            description: "Crawl local codebase".into(),
            intents: vec!["search".into(), "discovery".into()],
            priority: 0.65,
        },
        ...
        ToolNode {
            ...
            intents: vec!["code_execution".into(), "build".into(), "testing".into()],
            priority: 0.95,
        },
        ToolNode {
            tool_name: "execute_test".into(),
            description: "Run test suite".into(),
            intents: vec!["testing".into(), "code_execution".into()],
            priority: 0.85,
        },
        ToolNode {
            tool_name: "test_run".into(),
            description: "Run tests".into(),
            intents: vec!["testing".into(), "code_execution".into()],
            priority: 0.85,
        },
        ToolNode {
            tool_name: "lint_check".into(),
            description: "Lint code".into(),
            intents: vec!["code_review".into(), "testing".into()],
            priority: 0.7,
        },
        ToolNode {
            tool_name: "syntax_check".into(),
            description: "Check syntax".into(),
            intents: vec!["code_review".into(), "testing".into()],
            priority: 0.7,
        },
        ToolNode {
            tool_name: "code_coverage".into(),
            description: "Measure test coverage".into(),
            intents: vec!["testing".into(), "code_review".into()],
            priority: 0.65,
        },
        ToolNode {
            tool_name: "make".into(),
            description: "Run make targets".into(),
            intents: vec!["build".into(), "code_execution".into()],
            priority: 0.75,
        },
        ToolNode {
            tool_name: "docker".into(),
            description: "Docker container ops".into(),
            intents: vec!["code_execution".into(), "build".into()],
            priority: 0.7,
        },
        ToolNode {
            tool_name: "regex_test".into(),
            description: "Test regex patterns".into(),
            intents: vec!["testing".into(), "analysis".into()],
            priority: 0.55,
        },
        ToolNode {
            tool_name: "test_data_gen".into(),
            description: "Generate test data".into(),
        ...
        ToolNode {
            ...
            intents: vec!["git_operation".into()],
            priority: 0.85,
        },
        ToolNode {
            tool_name: "git_diff".into(),
            description: "Git diff".into(),
            intents: vec!["git_operation".into(), "code_review".into()],
            priority: 0.85,
        },
        ToolNode {
            tool_name: "git_log".into(),
            description: "Git log".into(),
            intents: vec!["git_operation".into(), "discovery".into()],
            priority: 0.75,
        },
        ToolNode {
        ...
        ToolNode {
            tool_name: "git_branch".into(),
            description: "Git branch management".into(),
            intents: vec!["git_operation".into()],
            priority: 0.65,
        },
        ToolNode {
        ...
        ToolNode {
            ...
            description: "Git stash ops".into(),
            intents: vec!["git_operation".into()],
            priority: 0.6,
        },
        ToolNode {
            tool_name: "git_blame".into(),
            description: "Git blame history".into(),
            intents: vec!["git_operation".into(), "code_review".into()],
            priority: 0.65,
        },
        ToolNode {
            tool_name: "changelog_gen".into(),
            description: "Generate changelog".into(),
            intents: vec!["git_operation".into(), "artifact_creation".into()],
            priority: 0.6,
        },
        // ── HTTP / external ───────────────────────────────────────────────
        ToolNode {
            ...
            intents: vec!["web_access".into(), "api_testing".into()],
            priority: 0.75,
        },
        ToolNode {
            tool_name: "http_probe".into(),
            description: "Probe HTTP endpoint".into(),
            intents: vec!["web_access".into(), "api_testing".into()],
            priority: 0.7,
        },
        ToolNode {
            tool_name: "port_check".into(),
            description: "Check port availability".into(),
            intents: vec!["discovery".into(), "api_testing".into()],
            priority: 0.6,
        },
        ToolNode {
            tool_name: "url_parse".into(),
            description: "Parse URL components".into(),
            intents: vec!["analysis".into(), "web_access".into()],
            priority: 0.5,
        },
        // ── Analysis & metrics ────────────────────────────────────────────
        ToolNode {
            tool_name: "code_metrics".into(),
            description: "Code complexity metrics".into(),
            intents: vec!["code_review".into(), "discovery".into()],
            priority: 0.65,
        },
        ToolNode {
            tool_name: "dep_check".into(),
            description: "Dependency audit".into(),
            intents: vec!["discovery".into(), "security".into()],
            priority: 0.6,
        },
        ToolNode {
            tool_name: "dependency_graph".into(),
            description: "Visualize dependencies".into(),
            intents: vec!["discovery".into(), "code_review".into()],
            priority: 0.6,
        },
        ToolNode {
            tool_name: "token_count".into(),
            description: "Count tokens in text".into(),
            intents: vec!["analysis".into()],
            priority: 0.5,
        },
        ToolNode {
            tool_name: "env_inspect".into(),
            description: "Inspect environment vars".into(),
            intents: vec!["discovery".into(), "code_execution".into()],
            priority: 0.55,
        },
        ToolNode {
            tool_name: "perf_analyze".into(),
            description: "Analyze performance data".into(),
            intents: vec!["analysis".into(), "code_review".into()],
            priority: 0.6,
        },
        ToolNode {
            tool_name: "parse_logs".into(),
            description: "Parse log files".into(),
            intents: vec!["analysis".into(), "discovery".into()],
            priority: 0.6,
        },
        ToolNode {
            tool_name: "ci_logs".into(),
            description: "Fetch CI build logs".into(),
            intents: vec!["discovery".into(), "testing".into()],
            priority: 0.65,
        },
        ToolNode {
            tool_name: "task_track".into(),
            description: "Track task progress".into(),
            intents: vec!["analysis".into()],
            priority: 0.5,
        },
        // ── Security & validation ─────────────────────────────────────────
        ToolNode {
            tool_name: "secret_scan".into(),
            description: "Scan for secrets/keys".into(),
            intents: vec!["security".into(), "code_review".into()],
            priority: 0.7,
        },
        ToolNode {
            tool_name: "openapi_validate".into(),
            description: "Validate OpenAPI spec".into(),
            intents: vec!["api_testing".into(), "code_review".into()],
            priority: 0.65,
        },
        ToolNode {
            tool_name: "json_schema_validate".into(),
            description: "Validate JSON schema".into(),
            intents: vec!["code_review".into(), "api_testing".into()],
            priority: 0.6,
        },
        ToolNode {
            tool_name: "config_validate".into(),
            description: "Validate config file".into(),
            intents: vec!["code_review".into(), "testing".into()],
            priority: 0.6,
        },
        // ── Process management ────────────────────────────────────────────
        ToolNode {
            ...
            intents: vec!["discovery".into(), "process_management".into()],
            priority: 0.6,
        },
        ToolNode {
            tool_name: "process_monitor".into(),
            description: "Monitor process metrics".into(),
            intents: vec!["discovery".into(), "process_management".into()],
            priority: 0.6,
        },
        ToolNode {
            tool_name: "background_start".into(),
            description: "Start background process".into(),
            intents: vec!["code_execution".into(), "process_management".into()],
            priority: 0.7,
        },
        ToolNode {
            tool_name: "background_output".into(),
            description: "Read background output".into(),
            intents: vec!["code_execution".into(), "process_management".into()],
            priority: 0.65,
        },
        ToolNode {
            tool_name: "background_kill".into(),
            description: "Kill background process".into(),
            intents: vec!["code_execution".into(), "process_management".into()],
            priority: 0.6,
        },
        // ── Data transformation ───────────────────────────────────────────
        ToolNode {
            ...
            description: "Transform JSON data".into(),
            intents: vec!["analysis".into(), "data_processing".into()],
            priority: 0.6,
        },
        ToolNode {
        ...
        ToolNode {
            tool_name: "template_engine".into(),
            description: "Render templates".into(),
            intents: vec!["artifact_creation".into()],
            priority: 0.55,
        },
    ]
}
...
mod tests {
    ...
    fn secondary_tools_excluded_from_primary() {
        ...
        for t in &result.secondary_tools {
            assert!(
                !primary_set.contains(t.as_str()),
                "secondary tool {t} also in primary"
            );
        }
    }
    ...
    fn merged_is_deduplicated() {
        ...
        assert_eq!(
            merged.len(),
            unique.len(),
            "merged must not contain duplicates"
        );
    }
