...
pub struct AppState {
    ...
    /// Number of content lines in the prompt (for dynamic height calculation).
    pub prompt_content_lines: usize,
    ...
    /// Real-time context servers information for modal display.
    pub context_servers: Vec<super::events::ContextServerInfo>,
    /// Total count of registered context servers.
    pub context_servers_total: usize,
    /// Number of enabled context servers.
    pub context_servers_enabled: usize,
