...
use cuervo_providers::ReplayProvider;
...
pub async fn run_replay(
    ...
    event_tx: &cuervo_core::EventSender,
    verify: bool,
) -> Result<ReplayResult> {
...
mod tests {
    use super::*;
    use cuervo_storage::{Database, TraceStep, TraceStepType};
    use chrono::Utc;
    ...
    fn test_event_tx() -> cuervo_core::EventSender {
    ...
    fn replay_uses_deterministic_seed() {
        ...
        matches!(ctx.uuid_gen, cuervo_core::types::UuidGenerator::Seeded { .. });
        matches!(ctx.clock, cuervo_core::types::ExecutionClock::Deterministic { .. });
    }
    ...
    fn replay_phase14_context_construction() {
        ...
        assert_eq!(phase14.dry_run_mode, cuervo_core::types::DryRunMode::Off);
