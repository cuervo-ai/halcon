//! Hierarchical instruction file loader (HALCON.md).
//!
...
/// 1. `~/.halcon/HALCON.md` (global)
/// 2. Walk from filesystem root down to `working_dir`, collecting any `HALCON.md` found
///
...
mod tests {
    ...
    fn no_files_returns_none() {
        ...
        // May find global HALCON.md if it exists on the dev machine,
