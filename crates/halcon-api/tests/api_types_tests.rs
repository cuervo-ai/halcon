use halcon_api::error::{ApiError, ErrorCode};
use halcon_api::types::agent::*;
use halcon_api::types::observability::*;
use halcon_api::types::protocol::*;
use halcon_api::types::system::*;
use halcon_api::types::task::*;
use halcon_api::types::tool::*;
use halcon_api::types::ws::*;
...
fn log_entry_serialization() {
    let entry = LogEntry {
        ...
        level: LogLevel::Info,
        target: "halcon_runtime::agent".into(),
...
#[test]
fn api_constants() {
    assert_eq!(halcon_api::API_VERSION, "v1");
    assert_eq!(halcon_api::DEFAULT_PORT, 9849);
    assert_eq!(halcon_api::DEFAULT_BIND, "127.0.0.1");
}
