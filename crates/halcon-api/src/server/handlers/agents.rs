...
pub async fn invoke_agent(
    ...
    use halcon_runtime::{AgentBudget, AgentRequest};
...
fn convert_agent_kind(kind: &halcon_runtime::AgentKind) -> AgentKind {
    match kind {
        halcon_runtime::AgentKind::Llm => AgentKind::Llm,
        halcon_runtime::AgentKind::Mcp => AgentKind::Mcp,
        halcon_runtime::AgentKind::CliProcess => AgentKind::CliProcess,
        halcon_runtime::AgentKind::HttpEndpoint => AgentKind::HttpEndpoint,
        halcon_runtime::AgentKind::HalconRemote => AgentKind::HalconRemote,
        halcon_runtime::AgentKind::Plugin => AgentKind::Plugin,
    }
}

fn convert_health(health: &halcon_runtime::AgentHealth) -> HealthStatus {
    match health {
        halcon_runtime::AgentHealth::Healthy => HealthStatus::Healthy,
