//! MCP Server: exposes halcon tools via the Model Context Protocol.
//!
...
/// MCP Server that exposes halcon tools over stdio JSON-RPC.
...
mod tests {
    use super::*;
    use halcon_core::error::Result as CoreResult;
    ...
    async fn handle_initialize() {
        ...
        assert_eq!(result["serverInfo"]["name"], "halcon-mcp-server");
