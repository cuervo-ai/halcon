...
mod tests {
    ...
    #[test]
    fn modality_of_image() {
        assert_eq!(modality_of(&DetectedMime::ImagePng), "image");
    }
    #[test]
    fn modality_of_audio() {
        assert_eq!(modality_of(&DetectedMime::AudioWav), "audio");
    }
    #[test]
    fn modality_of_video() {
        assert_eq!(modality_of(&DetectedMime::VideoMp4), "video");
    }
    #[test]
    fn modality_of_pdf() {
        assert_eq!(modality_of(&DetectedMime::Pdf), "unknown");
    }
}
